---
title: JWT App with Email Token Registration and Reset Password
date: 2021-09-29T23:49:31.040Z
description: As mentioned in JWT Login Flask post, more features have been added
  to Flask endpoint and ReactJS application, such as token registration via
  email and also password reset.
---
In this article we gonna describe the new features added to the Flask and ReactJS JWT application build and documented before here: [JWT Login Flask](https://patriciadourado.com/frompat/jwt-login-flask/).

## Flask Mail

To start we are going to use the Flask Mail extension to send emails through Flask from our endpoint to the user registered email on the ReactJS app.

![flaskmail](flaskmail.png "Flask-Mail")
...
*Note: I am using dotenv as a file to not expose my credentials and secret information, that is why the `os.getenv` is necessary.*

To install **dotenv** just run: 
`pip install python-dotenv`

As Flask Mail extension you will need to import doenv and load your credentials from .env file like following:
...
![registration-page](registration.png "Registration-Page")
...
![reset-password](reset-password.png "Reset-Password")
...
To have access to all the code for this Flask application you can visit my repository on github which also contains the address for the online application, [clicking here](https://github.com/patriciadourado/jwtlogin-flask).

You can also check the frontend ReactJS application developed to consume all these endpoints with the Registration, Login and Reset Password pages and validations for email and password, [clicking here](https://github.com/patriciadourado/jwtlogin-reactjs).

## Thank you

Hope you enjoyed! More featured coming soon. :)